...
#ifndef USING_SHT3X_ADDR
#define USING_SHT3X_ADDR SHT3X_ADDR_PD
#endif

#define RT_SHT3X_CTRL_RESET	0x10
#define RT_SHT3X_CTRL_HEATER	0x20
#define RT_SHT3X_CTRL_READ_STATE	0x21
#define RT_SHT3X_CTRL_READ_DATA	0x22

#define RT_SHT3X_HEATER_ON 0x31
#define RT_SHT3X_HEATER_OFF 0x30

struct rt_sth3x_data
{
	rt_int32_t type;
	rt_int32_t reg_address;
	rt_int32_t temperature_value;
	rt_int32_t humidity_value;
	rt_uint32_t fetch_time;
};
typedef struct rt_sth3x_data * sth3x_data_t;
...
typedef sht3x_status * sht3x_status_t;
