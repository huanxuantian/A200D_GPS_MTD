...
#ifdef USE_MODBUS_TCP_SLAVE
    #define MODBUS_TCP_SLAVE_ENABLE                 1
#endif

#ifdef USE_MODBUS_TCP_MASTER
...
/**
 ...
 @endverbatim
 */
#ifdef USE_MODBUS_ASCII_SLAVE
    #define MODBUS_ASCII_SLAVE_ENABLE           1
#endif

#ifdef USE_MODBUS_ASCII_MASTER
...
/**
 ...
 @endverbatim
 */
#ifdef USE_MODBUS_TCP_SLAVE_FOR_UDP
    #define MODBUS_TCP_SLAVE_FOR_UDP_ENABLE     1
#endif

#ifdef USE_MODBUS_TCP_MASTER_FOR_UDP
...
/**
 ...
 @endverbatim
 */
#ifdef USE_MODBUS_SERIAL_OVER_TCP
    #define MODBUS_SERIAL_OVER_TCP_ENABLE           1
#endif

#ifdef USE_MODBUS_SERIAL_OVER_UDP
 ...
 */
    ...
    #ifdef USE_SLAVE_DATA_DEVICE_BINDING
