...
extern void rt_show_appversion(void);
long appversion(void)
{
	rt_show_appversion();
    return 0;
}
FINSH_FUNCTION_EXPORT(appversion, show user appversion);
MSH_CMD_EXPORT(appversion, show user appversion);


extern void rt_show_date_time(void);
long show_datetime(void)
{
	rt_show_date_time();
    return 0;
}
FINSH_FUNCTION_EXPORT(show_datetime, show system time);
MSH_CMD_EXPORT(show_datetime, show system time);
